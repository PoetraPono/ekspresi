...
$(document).ready(function(){
  $("#divisi").change(function(){
      ...
      $.ajax({
  url:"<?php echo base_url();?>anggota/tampilkansubdivisi",
  data:"divisi=" + divisi ,
...
if($this->session->userdata('level')==2 || 3)
{
    $param="";
}
else
{
    $param=array('id_divisi'=>$this->session->userdata('keterangan'));
}
?>

<?php
echo form_open('anggota/profile');
?>
<div class="panel panel-default">
 ...
 <table class="table table-bordered">
  <tr class="success"><th colspan="2">PRIBADI</th></tr>
